...
public:
	...
	CHandle<CTeamControlPointRound> GetRoundGrnSpawn(void) { return m_hRoundGrnSpawn; }
...
private:
	...
	CHandle<CTeamControlPointRound>	m_hRoundGrnSpawn;
