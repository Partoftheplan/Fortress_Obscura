...
{
	if ( iTeam1 == TF_TEAM_RED && iTeam2 == TF_TEAM_BLUE && iTeam2 == TF_TEAM_GRN)
		return true;

	if ( iTeam1 == TF_TEAM_BLUE && iTeam2 == TF_TEAM_RED && iTeam2 == TF_TEAM_GRN)
		return true;

	if ( iTeam1 == TF_TEAM_GRN && iTeam2 == TF_TEAM_RED && iTeam2 == TF_TEAM_BLUE)
		return true;
