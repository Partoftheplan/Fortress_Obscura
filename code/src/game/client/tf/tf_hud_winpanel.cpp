...
void CTFWinPanel::FireGameEvent( IGameEvent * event )
{
	...
	else if ( Q_strcmp( "teamplay_win_panel", pEventName ) == 0 )
	{
		...
		case TF_TEAM_RED:
			...
			break;
		case TF_TEAM_GRN:
			pImagePanelBG->SetImage("../hud/winpanel_grn_bg_main.vmt");
			pTeamLabel = (bRoundComplete ? "#Winpanel_GrnWins" : (bIsAreaDefense ? "#Winpanel_GrnDefends" : "#Winpanel_RedAdvances"));
			pTopPlayersLabel = "#Winpanel_GrnMVPs";
			pLocalizedTeamName = g_pVGuiLocalize->Find("TF_GrnTeam_Name");
			break;
