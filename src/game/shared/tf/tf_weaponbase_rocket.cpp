...
{ 
	...
	if ( m_bCollideWithTeammates == false )
	{
		...
		{
		case TF_TEAM_RED:
			teamContents = CONTENTS_BLUETEAM | CONTENTS_GRNTEAM | CONTENTS_YLWTEAM | CONTENTS_PRPTEAM | CONTENTS_BRWTEAM;
			break;

		case TF_TEAM_BLUE:
			teamContents = CONTENTS_REDTEAM | CONTENTS_GRNTEAM | CONTENTS_YLWTEAM | CONTENTS_PRPTEAM | CONTENTS_BRWTEAM;
			break;

		case TF_TEAM_GRN:
			teamContents = CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_YLWTEAM | CONTENTS_PRPTEAM | CONTENTS_BRWTEAM;
			break;

		case TF_TEAM_YLW:
			teamContents = CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_GRNTEAM | CONTENTS_PRPTEAM | CONTENTS_BRWTEAM;
			break;

		case TF_TEAM_PRP:
			teamContents = CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_GRNTEAM | CONTENTS_YLWTEAM | CONTENTS_BRWTEAM;
			break;

		case TF_TEAM_BRW:
			teamContents = CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_GRNTEAM | CONTENTS_YLWTEAM | CONTENTS_PRPTEAM;
			break;
		}
	}
	else
	{
		...
		teamContents = CONTENTS_REDTEAM | CONTENTS_BLUETEAM | CONTENTS_GRNTEAM | CONTENTS_YLWTEAM | CONTENTS_PRPTEAM | CONTENTS_BRWTEAM;
	}
