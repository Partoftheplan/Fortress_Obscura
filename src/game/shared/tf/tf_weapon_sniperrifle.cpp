...
#define SNIPER_DOT_SPRITE_YLW		"effects/sniperdot_ylw.vmt"
#define SNIPER_DOT_SPRITE_GRN		"effects/sniperdot_grn.vmt"
#define SNIPER_DOT_SPRITE_PRP		"effects/sniperdot_prp.vmt"
#define SNIPER_DOT_SPRITE_BRW		"effects/sniperdot_BRWn.vmt"
	...
	if ( updateType == DATA_UPDATE_CREATED )
	{
		...
		else
		{
			...
			else
			{
				...
				{
					m_hSpriteMaterial.Init(SNIPER_DOT_SPRITE_YLW, TEXTURE_GROUP_CLIENT_EFFECTS);
				}
				else
				{
					if (GetTeamNumber() == TF_TEAM_GRN)
					{
						m_hSpriteMaterial.Init(SNIPER_DOT_SPRITE_GRN, TEXTURE_GROUP_CLIENT_EFFECTS);
					}
					else
					{
						if (GetTeamNumber() == TF_TEAM_PRP)
						{
							m_hSpriteMaterial.Init(SNIPER_DOT_SPRITE_PRP, TEXTURE_GROUP_CLIENT_EFFECTS);
						}
						else
						{
							m_hSpriteMaterial.Init(SNIPER_DOT_SPRITE_BRW, TEXTURE_GROUP_CLIENT_EFFECTS);
						}
					}
				}
			}
