...
enum
{
	TF_TEAM_RED = LAST_SHARED_TEAM+5,
	TF_TEAM_BLUE,
	TF_TEAM_YLW,
	TF_TEAM_GRN,
	TF_TEAM_PRP,
...
#define CONTENTS_YLWTEAM	CONTENTS_UNUSED
#define CONTENTS_GRNTEAM	CONTENTS_UNUSED6
#define CONTENTS_PRPTEAM	CONTENTS_TESTFOGVOLUME
#define CONTENTS_BRWTEAM	CONTENTS_UNUSED
...
#define PANEL_CLASS_YLW			"class_ylw"
#define PANEL_CLASS_GRN			"class_grn"
#define PANEL_CLASS_PRP			"class_prp"
#define PANEL_CLASS_BRW			"class_brw"
...
#define COLOR_TF_YLW	Color( 255, 255, 64, 255 )
#define COLOR_TF_GRN	Color( 64, 255, 255, 255 )
#define COLOR_TF_PRP	Color( 255, 64, 255, 255 )
#define COLOR_TF_BRW	Color( 87, 87, 64, 255 )
