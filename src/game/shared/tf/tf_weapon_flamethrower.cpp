...
void CTFFlameThrower::RestartParticleEffect( void )
{
	...
	else
	{
		...
		if ( m_bCritFire )
	    {
		    pszParticleEffect = (pOwner->GetTeamNumber() == TF_TEAM_YLW ? "flamethrower_ylw" : "flamethrower");
	    }
		else
		{
			pszParticleEffect = (pOwner->GetTeamNumber() == TF_TEAM_GRN ? "flamethrower_grn" : "flamethrower");
		}
		if (m_bCritFire)
		{
			pszParticleEffect = (pOwner->GetTeamNumber() == TF_TEAM_PRP ? "flamethrower_prp" : "flamethrower");
		}
		else
		{
			pszParticleEffect = (pOwner->GetTeamNumber() == TF_TEAM_PRP ? "flamethrower_prp" : "flamethrower");
