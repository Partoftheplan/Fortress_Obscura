...
void C_TFProjectile_Rocket::CreateRocketTrails( void )
{
	...
	if ( m_bCritical )
	{
		...
		case TF_TEAM_RED:
			...
			break;
		case TF_TEAM_YLW:
			ParticleProp()->Create("critical_rocket_ylw", PATTACH_ABSORIGIN_FOLLOW);
			break;
		case TF_TEAM_GRN:
			ParticleProp()->Create("critical_rocket_grn", PATTACH_ABSORIGIN_FOLLOW);
			break;
		case TF_TEAM_PRP:
			ParticleProp()->Create("critical_rocket_prp", PATTACH_ABSORIGIN_FOLLOW);
			break;
		case TF_TEAM_BRW:
			ParticleProp()->Create("critical_rocket_brw", PATTACH_ABSORIGIN_FOLLOW);
			break;
		default:
			break;
		}
