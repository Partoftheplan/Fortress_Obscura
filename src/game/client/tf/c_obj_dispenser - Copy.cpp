		...
		if ( pTarget )
		{
			...
			else
			{
				...
				else
				{
					...
					{
						pszEffectName = "dispenser_heal_ylw";
					}
					else
					{
						if (GetTeamNumber() == TF_TEAM_GRN)
						{
							pszEffectName = "dispenser_heal_grn";
						}
						else
						{
							if (GetTeamNumber() == TF_TEAM_PRP)
							{
								pszEffectName = "dispenser_heal_prp";
							}
							else
							{
								if (GetTeamNumber() == TF_TEAM_BRW)
								{
									pszEffectName = "dispenser_heal_brw";
								}
								else
								{
