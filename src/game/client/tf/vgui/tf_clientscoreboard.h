...
private:
	...
	vgui::SectionedListPanel	*m_pPlayerListYlw;
	vgui::SectionedListPanel	*m_pPlayerListGrn;
	vgui::SectionedListPanel	*m_pPlayerListPrp;
	vgui::SectionedListPanel	*m_pPlayerListBrw;
