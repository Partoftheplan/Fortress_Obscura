...
CON_COMMAND( changeclass, "Choose a new class" )
{
	...
	if ( pPlayer && pPlayer->CanShowClassMenu() )
	{
		...
		case TF_TEAM_BLUE:
			...
			break;
		case TF_TEAM_YLW:
			gViewPortInterface->ShowPanel(PANEL_CLASS_YLW, true);
			break;
		case TF_TEAM_GRN:
			gViewPortInterface->ShowPanel(PANEL_CLASS_GRN, true);
			break;
		case TF_TEAM_PRP:
			gViewPortInterface->ShowPanel(PANEL_CLASS_PRP, true);
			break;
		case TF_TEAM_BRW:
			gViewPortInterface->ShowPanel(PANEL_CLASS_BRW, true);
			break;
		default:
			break;
		}
...
//		newpanel = new CTFMapOverview( this );
	...
	else if ( Q_strcmp( PANEL_CLASS_YLW, szPanelName) == 0)
	{
		newpanel = new CTFClassMenu_Ylw(this);
	}
	else if ( Q_strcmp( PANEL_CLASS_GRN, szPanelName) == 0)
	{
		newpanel = new CTFClassMenu_Grn(this);
	}
	else if ( Q_strcmp( PANEL_CLASS_PRP, szPanelName) == 0)
	{
		newpanel = new CTFClassMenu_Prp(this);
	}
	else if ( Q_strcmp( PANEL_CLASS_BRW, szPanelName) == 0)
	{
		newpanel = new CTFClassMenu_Brw(this);
	}
...
void TFViewport::CreateDefaultPanels( void )
{
	...
	AddNewPanel( CreatePanelByName( PANEL_CLASS_YLW ), "PANEL_CLASS_YLW" );
	AddNewPanel( CreatePanelByName( PANEL_CLASS_GRN ), "PANEL_CLASS_GRN" );
	AddNewPanel( CreatePanelByName( PANEL_CLASS_PRP ), "PANEL_CLASS_PRP" );
	AddNewPanel( CreatePanelByName( PANEL_CLASS_PRP ), "PANEL_CLASS_BRW" );
