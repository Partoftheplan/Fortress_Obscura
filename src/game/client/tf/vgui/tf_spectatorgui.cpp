...
void CTFSpectatorGUI::UpdateReinforcements( void )
{
	...
	if ( !pPlayer || pPlayer->IsHLTV() ||
		...
		(pPlayer->GetTeamNumber() != TF_TEAM_RED && pPlayer->GetTeamNumber() != TF_TEAM_BLUE && pPlayer->GetTeamNumber() != TF_TEAM_GRN && pPlayer->GetTeamNumber() != TF_TEAM_YLW && pPlayer->GetTeamNumber() != TF_TEAM_PRP && pPlayer->GetTeamNumber() != TF_TEAM_PRP) ||
