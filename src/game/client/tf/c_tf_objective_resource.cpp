...
C_TFObjectiveResource::C_TFObjectiveResource()
{
	...
	PrecacheMaterial( "sprites/obj_icons/icon_obj_cap_prp" );
	PrecacheMaterial( "sprites/obj_icons/icon_obj_cap_brw" );
}
...
const char *C_TFObjectiveResource::GetGameSpecificCPCappingSwipe( int index, int iCappingTeam )
{
	...
	case TF_TEAM_YLW:
		...
		break;
	case TF_TEAM_PRP:
		return "sprites/obj_icons/icon_obj_cap_prp";
		break;
	case TF_TEAM_BRW:
		return "sprites/obj_icons/icon_obj_cap_brw";
		break;
	default:
		return "sprites/obj_icons/icon_obj_cap_blu";
		break;
...
const char *C_TFObjectiveResource::GetGameSpecificCPBarFG( int index, int iOwningTeam )
{
	...
	case TF_TEAM_YLW:
		...
		break;
	case TF_TEAM_PRP:
		return "progress_bar_prp";
		break;
	case TF_TEAM_BRW:
		return "progress_bar_brw";
		break;
	default:
		return "progress_bar";
		break;
